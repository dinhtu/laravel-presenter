...
class CommonUtils
{
    public static function setFlash($message, $mode = 'success', $urlRedirect = '')
    {
     ...
     * @return  string
     */
    public static function checkRfidCode($rfidCode)
    {
        return preg_match('/^[a-zA-Z0-9][a-zA-Z0-9]*$/i', $rfidCode);
    }

    public static function checkReturnCsvContent($column)
    {
        $ret = 0;
        if ($column == '') {
            $ret = 1; // Blank OR NULL
    ...
    public static function logInfo($request, $message = '')
    {
    ...
    public static function logError($request, $message = '')
    {
    ...
    public static function logWarning($request, $message = '')
    {
    ...
    public static function convertShijis($text)
    {
        return mb_convert_encoding($text, 'SJIS', 'UTF-8');
    }

    public static function saveOperationLog($request, $operationType = OperationType::INSERT)
    {
    ...
    public static function getData($line, $column)
    {
    ...
    public static function mergeSession($data)
    {
        $dataSession = '';
    ...
    public static function sortLinks($routeName, $data, $request)
    {
        $link = [];
